        ...
        if($island instanceof Island) {
            if(!$event->getPlayer()->isOp() and !in_array(strtolower($event->getPlayer()->getName()), $island->getAllMembers())) {
                ...
                if($event->getBlock()->getId() == Block::COBBLESTONE) {
                    $items = [];
                    $items[] = Item::get(264);
                    $this->addItemMultipleTimes(4, Item::get(265), $items);
                    $this->addItemMultipleTimes(2, Item::get(266), $items);
                    $this->addItemMultipleTimes(4, Item::get(352), $items);
                    $this->addItemMultipleTimes(8, Item::get(Item::COAL), $items);
                    $this->addItemMultipleTimes(4, Item::get(320), $items);
                    $this->addItemMultipleTimes(90, Item::get(Item::COBBLESTONE), $items);
